...
int main()
{
    ...
    //Vou alocar um grande numero de espaço incialmente, depois será realocado
    trainList = (int*)malloc(4000*sizeof(int));

    //Inicializar seed random
    srand(time(NULL));

    //ABRIR ARQUIVO DE DATA
    data = fopen("bike.csv","r");
    if (data==NULL)
    {
